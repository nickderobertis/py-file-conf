...
from dero.manager.imports.logic.parse.main import (
    parse_import_lines_return_import_models,
...
class DataConfigFile(ConfigFileBase):
    ...
    def _config_to_file_lines(self, config: 'DataConfig') -> Tuple[List[str], List[str]]:
