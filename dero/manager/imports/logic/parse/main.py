...
def parse_import_lines_return_import_models(import_lines: List[str]) -> List[AnyImportStatement]:
    ...
    return [_parse_import_statement_str_return_import_model(import_statement) for import_statement in import_statements]
